...
const DEFAULT_LEADERSHIP: LeadershipProfileDto[] = [
  ...
  },
  {
    ...
    name: "Deepak",
    role: "ADMIN",
    primaryRole: "Co-Founder & Community Lead",
    leadershipPosition: "CO_FOUNDER",
    headline: "Co-Founder • Community & Development • Team Support",
    publicBio: "Deepak coordinates community outreach, developer collaboration and operational workflows at CodeXa Agency, driving peer learning and technical growth.",
    quote: "Helping every developer grow together.",
    mediaUrl: "/assets/images/2299fdd2a1d01339a71af61a2c7e9cac.jpg",
    skills: ["Team Operations", "Community Building", "Application Review", "Developer Relations"],
    displayOrder: 2,
    isPublic: true,
  },
  {
    ...
    name: "Venu",
    role: "ADMIN",
    primaryRole: "CEO & Strategy Lead",
    leadershipPosition: "CEO",
    headline: "CEO • Strategy • Client Operations • Technology",
    publicBio: "Venu directs executive strategy, client engagements and platform scaling at CodeXa Agency, combining business acumen with continuous technical expansion.",
    quote: "Vision creates companies. Execution builds them.",
    mediaUrl: "/assets/images/2306fc1d8f6ea04d1ddd4ebfafd003f2.jpg",
    skills: ["Executive Strategy", "Client Operations", "Business Growth", "Product Direction"],
    displayOrder: 3,
    isPublic: true,
  },
];
