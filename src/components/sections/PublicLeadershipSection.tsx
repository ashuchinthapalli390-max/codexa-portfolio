...
const DEFAULT_LEADERSHIP: LeadershipProfileDto[] = [
  {
    ...
    featuredProjects: [
      { name: "Nexa AI", category: "Artificial Intelligence", url: "https://nexa-ai.xyz/" },
      { name: "Nexa IDE", category: "Developer Platform", url: "https://codxa-agency.online/" },
      { name: "CloudWave", category: "Cloud Infrastructure", url: "https://cloudewave.in/" },
      { name: "NEC Portal", category: "Institutional Platform", url: "https://nec-portal-rosy.vercel.app/" },
      { name: "NodeWave", category: "Developer System", url: "https://nodewave.in/" },
      { name: "CodeAxis Apply", category: "Recruitment Universe", url: "https://www.codeaxisapply.xyz/" },
      { name: "CodeXa Agency", category: "Agency Platform", url: "https://codxa-agency.online/" },
      { name: "EDITH AI Agent", category: "AI Agent", url: "https://codxa-agency.online/" },
    ],
    displayOrder: 1,
    isPublic: true,
  },
  {
    ...
    featuredProjects: [
      { name: "StarX Live", category: "Live Music & Entertainment", url: "https://starx-live-official.vercel.app/" },
      { name: "TicketX", category: "Ticketing & Event Platform", url: "https://ticket-x-theta.vercel.app/" },
    ],
    displayOrder: 2,
    isPublic: true,
  },
